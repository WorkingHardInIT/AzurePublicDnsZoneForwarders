...
Function RunAzureConditionalForwarderMaintenance {
    ...
    Switch ($Action) {
        'Add' { AddConditionalForwarders -AzurePublicDnsZoneForwarders $NoEmptiesWithRegionsWithPartitionsSqlInstancesAllAzurePublicDnsZoneForwarders -DnsServer2Forward2 $DnsServer2Forward2 }
...
$CsvFilePath = "C:\SysAdmin\Scripting\AzurePublicDnsZoneForwarders.csv" #Loading CSV file
